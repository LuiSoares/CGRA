...
LightingScene.prototype.init = function(application) {
	...
	//2.2 (Nota: poderá ter de ajustar aincialização do MyQuad​ de floor​ para esse efeito)
	...
	//2.2. Crie a CGFappearance floorAppearance
	this.floorAppearance = new CGFappearance(this);
	this.floorAppearance.loadTexture("../resources/images/floor.png");
	this.floorAppearance.setTextureWrap('REPEAT', 'REPEAT');
    //2.3.Substitua a parede da esquerda por um MyQuad em vez de um Plane
	...
	//1.2. Na função init da cena, ative a utilização de texturas
...
LightingScene.prototype.display = function() {
	...
	this.pushMatrix();	
		...
		this.floorAppearance.apply();  //2.2
		this.floor.display();
	this.popMatrix();
	...
	this.pushMatrix();
		...
		this.scale(15, 8, 0.2);
		this.windowAppearance.apply(); // 2.3
		this.wall.display();
	this.popMatrix();
